...
public class PlayerControls : MonoBehaviour
{
    ...
    [Tooltip("How fast ship moves up and down based upon player input")] [SerializeField] float controllSpeed = 10f; 
    ...
    {   
        ...
        float pitchDueToControlThrow = yThrow * controllPitchFactor;
